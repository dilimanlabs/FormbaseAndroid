 ...
 */
public class FormbaseAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = "FormsbaseAuthenticator";
    private final Context mContext;
    private final Handler mHandler = new Handler();

    public FormbaseAuthenticator(Context context) {
        super(context);
